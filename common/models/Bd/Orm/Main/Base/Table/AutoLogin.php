...
abstract class Bd_Orm_Main_Base_Table_AutoLogin extends Bd_Db_Table
{
    ...
    private static $_name = 'auto_login';

    private static $_swap_name = null;

    private static $_record_class_name = 'Bd_Orm_Main_AutoLogin';

    protected static $_class_suffix = 'AutoLogin';
    ...
    private static $_pkeys = array('hash');
